...
double BTaggingRoutineTopTag::GetScaleWeight()
{
    ...
    for(unsigned int i=0; i<bcc->jets->size(); ++i)
    {
      ...
      if(!((deltaphi<(2*PI/3))&&(bcc->jets->at(i).pt()>30.)&&(fabs(bcc->jets->at(i).eta())<2.5))) continue;
	...
	numpt=(TH1F*) file_mc->Get("BTagEff/pt_bJet_bTag");
	...
	numpt=(TH1F*) file_mc->Get("BTagEff/pt_cJet_bTag");
	...
	if(eta>=0&&eta<=0.8)
	{
	  denpt=(TH1F*) file_mc->Get("BTagEff/pt_lJet_e1");
	  numpt=(TH1F*) file_mc->Get("BTagEff/pt_lJet_e1_bTag");
	  effipt=new TH1F("effipt","effi pt", 16, jetpt_bins);
	}
	else if(eta>0.8&&eta<=1.6)
	{
	  denpt=(TH1F*) file_mc->Get("BTagEff/pt_lJet_e2");
	  numpt=(TH1F*) file_mc->Get("BTagEff/pt_lJet_e2_bTag");
	  effipt=new TH1F("effipt","effi pt", 16, jetpt_bins);
	}
	else if(eta>1.6&&eta<=2.4)
	{
	  denpt=(TH1F*) file_mc->Get("BTagEff/pt_lJet_e3");
	  numpt=(TH1F*) file_mc->Get("BTagEff/pt_lJet_e3_bTag");
	  effipt=new TH1F("effipt","effi pt", 16, jetpt_bins);
	}
	else
	{
