...
void BTVCycle::BeginInputData( const SInputData& id ) throw( SError ) 
{
  ...
  RegisterHistCollection( new BTVHists("NoCuts") );
  RegisterHistCollection( new HypothesisHists("Chi2_NoCuts", m_chi2discr ) );

  //histograms with and without b tagging
  RegisterHistCollection( new BTVHists("BTag") );
  RegisterHistCollection( new BTVHists("NoBTag") );
  ...
  RegisterHistCollection( new BTVHists("TopSel") );
